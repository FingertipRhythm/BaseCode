 ...
 *  通常情况下,我们都选择省略"this.".特殊情况下,如果方法的形参和类的属性同名时,我们必修显式
 *  的使用"this.变量"的方式,表明此变量时属性,而非形参.
 *
 *  2.2 在类的构造器中,我们可以使用"this.属性"或"this.方法"的方式.调用当前对象属性或方法.但是,
 *  通常情况下,我们都选择省略"this.".特殊情况下,如果构造器的形参和类的属性同名时,我们必修显式
 *  的使用"this.变量"的方式,表明此变量时属性,而非形参.
 *
 * 3.this调用构造器
